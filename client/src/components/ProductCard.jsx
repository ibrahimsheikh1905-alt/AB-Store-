...
const ProductCard = ({ product }) => {
  ...
  // ❗ Real store rule: agar image hi nahi hai to card show mat karo
  ...
  return (
    ...
    >
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-orange-500/15 via-white to-sky-500/15 opacity-0 blur-2xl transition duration-500 group-hover:opacity-100" />
        ...
        <div className="px-5 pb-5">
          <button
            ...
            className={`group/button w-full rounded-xl py-3 font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${
              product.inStock
                ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/35 hover:shadow-orange-500/45'
